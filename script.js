...
function check(cell) {
  ...
  if (
    ...
    (gbarray[0].textContent == "X" || gbarray[0].textContent == "O") &&
    (gbarray[1].textContent == "X" || gbarray[1].textContent == "O") &&
    (gbarray[2].textContent == "X" || gbarray[2].textContent == "O") &&
    (gbarray[3].textContent == "X" || gbarray[3].textContent == "O") &&
    (gbarray[4].textContent == "X" || gbarray[4].textContent == "O") &&
    (gbarray[5].textContent == "X" || gbarray[5].textContent == "O") &&
    (gbarray[6].textContent == "X" || gbarray[6].textContent == "O") &&
    (gbarray[7].textContent == "X" || gbarray[7].textContent == "O") &&
    (gbarray[8].textContent == "X" || gbarray[8].textContent == "O")
  ) {
...
cells.forEach((cell) => cell.addEventListener("click", () => display(cell)));
